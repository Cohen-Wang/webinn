(function (window) {
    ...
    Point.prototype = {
        ...
        add: function (options) {
            ...
            newPoint.x += options.x;
            newPoint.y += options.y;
            return newPoint;
        },
    ...
    Heart = function () {
        ...
        // 沿心型，画点的坐标
        for (var i = 10; i < 30; i += 0.2) {// 0.2 型芯弧边的密度
            t = i / Math.PI;
            x = 16 * Math.pow(Math.sin(t), 3);// 16 心型大小
            y = 13 * Math.cos(t) - 5 * Math.cos(2 * t) - 2 * Math.cos(3 * t) - Math.cos(4 * t);// 13 心型大小
    ...
    Seed.prototype = {
        ...
        canMove: function () {
            return this.cirle.point.y < (this.tree.height + 20);// 写死了
        },
        // public
        move: function (x, y) {
            this.clear();
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.save();
            ctx.beginPath();
            ctx.fillStyle = 'rgb(255, 0, 0)';// 'rgb(35, 31, 32)'
    ...
    Bloom.prototype = {
        ...
        flower: function () {
            ...
            this.scale += 0.1;
            if (this.scale > 1) {
                this.tree.removeBloom(this);// 停止放大
            }
        },
    ...
    Tree.prototype = {
        initSeed: function () {
            ...
            this.seed = new Seed(this, point, scale, color);// 初始化
        },
        initFooter: function () {
            ...
            this.footer = new Footer(this, width, height, speed);// 初始化
        },
        initBranch: function () {
        ...
        addBranchs: function (branchs) {
        	...
        	for (var i = 0; i < branchs.length; i++) {
                ...
                s.addBranch(new Branch(s, p1, p2, p3, r, l, c));// 初始化
            }
        },
        ...
        createBloom: function (width, height, radius, figure, color, alpha, angle, scale, place, speed) {
            ...
            while (true) {
                ...
                if (inheart(x - width / 2, height - (height - 40) / 2 - y, radius)) {
                    return new Bloom(this, new Point(x, y), figure, color, alpha, angle, scale, place, speed);// 初始化
                }
            }
        },
        canFlower: function () {
