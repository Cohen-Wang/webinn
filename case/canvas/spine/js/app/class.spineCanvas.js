...
(function () {
    ...
    CYBER.SpineCanvas = function (params) {
        ...
        this.animationName = params.animationName || 'walk';
        this.width = params.width;
        this.height = params.height;
        this.left = params.left;
        this.top = params.top;
        this.isShowCoordinate = params.isShowCoordinate;
        this.debugRendering = params.debugRendering;
        this.oContainer = document.getElementById(params.id);
        //
        this.skeleton = null;
        this.state = null;
        this.bounds = null;
    ...
    CYBER.SpineCanvas.prototype.init = function () {
        ...
        this.can.style.backgroundColor = 'rgba(255,255,255,0)';
        ...
        this.assetManager.loadText("res/" + this.skeletonName + ".json");
        this.assetManager.loadText("res/" + this.skeletonName + ".atlas");
        this.assetManager.loadTexture("res/" + this.skeletonName + ".png");
        //
        this.load();
    };
     ...
     */
     CYBER.SpineCanvas.prototype.loadSkeleton = function (skeletonName, animationName, skin) {
        ...
        skin = skin || "default";
        // 加载atlas
        let atlas = new spine.TextureAtlas(this.assetManager.get("res/" + skeletonName + ".atlas"), function(path) {
            return _this.assetManager.get("res/" + path);
        });
        ...
        let skeletonData = skeletonJson.readSkeletonData(this.assetManager.get("res/" + skeletonName + ".json"));
        // 外面要用的变量1
